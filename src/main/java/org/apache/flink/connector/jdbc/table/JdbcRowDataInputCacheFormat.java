 ...
 */
@Internal
public class JdbcRowDataInputCacheFormat extends RichInputFormat<RowData, InputSplit> implements ResultTypeQueryable<RowData> {

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LoggerFactory.getLogger(JdbcRowDataInputCacheFormat.class);
	...
	private JdbcRowDataInputCacheFormat(
	...
	/**
	 * Builder for {@link JdbcRowDataInputCacheFormat}.
	 */
	public static class Builder {
		...
		public JdbcRowDataInputCacheFormat build() {
			...
			return new JdbcRowDataInputCacheFormat(
